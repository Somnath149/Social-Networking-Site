...
function Upload() {
    ...
    return (
        <div className='w-full h-[100vh] bg-black flex flex-col items-center pt-[80px]'>
            ...
            {frontendMedia &&
                <button className='px-[10px] w-[60%] max-w-[400px] py-[5px] h-[50px] bg-[white] mt-[50px] cursor-pointer rounded-2xl flex justify-center items-center'
                    onClick={handleUpload} disabled={loading}>
                    {loading ? <div className='loader border-t-2 border-b-2 border-black w-[20px] h-[20px] rounded-full animate-spin'></div> : `Upload ${uploadType}`}
                </button>
            }
        </div>
    )
